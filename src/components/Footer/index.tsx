  ...
  return (
    <footer className="w-full bg-[#07172A] relative">
      <div className="footer-header">
        <p className="text-2xl sm:text-3xl font-medium text-center text-white pt-5">
          Rejoignez
          {' '}
      ...
      <div className="flex-col sm:flex-row flex justify-center gap-9 mt-4 mb-9 py-9 text-center">
        <div>
          <div className="text-2xl text-white pb-4">Adresse</div>
        ...
        <div>
          <div className="text-2xl text-white pb-4">Contact</div>
          <div className="text-primaryColor">
            <p>0 821 23 08 72</p>
        ...
        <div>
          <div className="text-2xl text-white pb-4">Mails</div>
          <div className="text-primaryColor">
      ...
      <div className="w-full bg-secondaryColor text-white flex gap-5 justify-around items-center p-5">
        <p className="hover:text-primaryColor ease-linear duration-200 cursor-pointer">Condition Générales des Ventes</p>
        <p className="hover:text-primaryColor ease-linear duration-300 cursor-pointer">Conditions Générales des Expéditions</p>
        <p className="hover:text-primaryColor ease-linear duration-300 cursor-pointer">Politique de Confidentialité</p>
